...
export default function TextPresentation(): ReactElement {
  return (
    <>
      <h2 className="whitespace-nowrap duration-75 ease-in">VICTOR NAVARRO</h2>
      <p className="text-White mb-10 duration-75 ease-in font-bold">DESENVOLVEDOR DE SOFTWARE</p>
      <p className="leading-loose text-justify duration-75 ease-in font-semibold">
